...
loss="relResponseAsy"
NN_mode="xy"
trainingname="TF_Taylor_CrossVal_woutReweight_uniformBatchpTtrainval_wSumEt_woutScale_woutVertexReweight_300Batch_100000GS_20_200_4HL_${PhysicsProcess}_${NN_mode}_${optimizer}_${loss}reduce_mean_sum"
echo "$trainingname"
