...
PhysicsProcess="Mu"
optimizer="Adam"
loss="relAngle_relResponse"
NN_mode="xy"
trainingname="TF_Reweight_pTindependentloss_woutScale_1000Batch_100000GS_20_200_4HL_${PhysicsProcess}_${NN_mode}_${optimizer}_${loss}"
echo "$trainingname"
