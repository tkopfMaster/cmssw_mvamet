...
treeName = 't'
arrayName = rnp.root2array(fName, treeName, branches=['Boson_Pt','MVAMET_Pt', 'MVAMET_Phi', 'NVertex' , 'recoilslimmedMETs_LongZ', 'recoilslimmedMETs_PerpZ',  'recoilslimmedMETsPuppi_PerpZ', 'recoilslimmedMETsPuppi_LongZ', 'recoilpatpfNoPUMET_PerpZ','recoilpatpfNoPUMET_LongZ','recoilpatpfPUCorrectedMET_PerpZ', 'recoilpatpfPUCorrectedMET_LongZ', 'recoilpatpfPUMET_PerpZ', 'recoilpatpfPUMET_LongZ', 'recoilpatpfTrackMET_PerpZ', 'recoilpatpfTrackMET_LongZ', 'LongZCorrectedRecoil_PerpZ', 'LongZCorrectedRecoil_LongZ' ],)
DFName = pd.DataFrame.from_records(arrayName.view(np.recarray))
...
plt.grid()
#plt.ylim(-0.005,2.)
plt.savefig("%sHistogramVertices"%(plotsD))
...
plt.grid()
#plt.ylim(-0.005,2.)
plt.savefig("%sHistogrampTZ"%(plotsD))
...
plt.grid()
plt.ylim(-0.005,2.)
plt.savefig("%sResponseBoson_PtWeighted"%(plotsD))
plt.show()
'''
...
plt.savefig("%sResponseOverpTZ_wError"%(plotsD))
#plt.show()
...
plt.grid()
plt.ylim(ResponseMin, ResponseMax)
plt.savefig("%sResponseOverpTZ_woutError"%(plotsD))
#plt.show()
...
plt.grid()
plt.ylim(ResponseMin, ResponseMax)
plt.savefig("%sResponseOverNVertex_wError"%(plotsD))
#plt.show()
...
plt.grid()
plt.ylim(ResponseMin, ResponseMax)
plt.savefig("%sResponseOverNVertex_woutError"%(plotsD))
#plt.show()
...
plt.savefig("%sResolutionUParaOverPTZ"%(plotsD))
#plt.show()
...
plt.grid()
plt.ylim(ylimResMin, ylimResMax)
plt.savefig("%sResolutionU_paraOverNVertex"%(plotsD))
#plt.show()
...
plt.grid()
plt.ylim(ylimResMin, ylimResMax)
plt.savefig("%sResolutionUPerpOverPTZ"%(plotsD))
#plt.show()
...
plt.grid()
plt.ylim(ylimResMin, ylimResMax)
plt.savefig("%sResolutionUPerpOverNVertex"%(plotsD))
#plt.show()
...
plt.grid()
plt.ylim(ylimResMin, ylimResMax)
plt.savefig("%sInversedResponseOverPTZ"%(plotsD))
#plt.show()
...
plotMVAResponseOverpTZ_woutError('LongZCorrectedRecoil_LongZ', 'MVA', 0)
plotMVAResponseOverpTZ_woutError('recoilslimmedMETsPuppi_LongZ', 'Puppi', 2)
...
plt.savefig("%sResponseMVA_u_para_OverPTZ"%(plotsD))

fig=plt.figure(figsize=(10,6))
fig.patch.set_facecolor('white')
ax = plt.subplot(111)

plotMVAResponseOverpTZ_wError('LongZCorrectedRecoil_LongZ', 'MVA', 0)
plotMVAResponseOverpTZ_wError('recoilslimmedMETsPuppi_LongZ', 'Puppi', 2)
...
plt.grid()
plt.ylim(0.6, ResponseMax)
plt.savefig("%sResponseMVA_u_para_OverPTZ_wError"%(plotsD))
...
plotMVAResponseOverNVertex_woutError('LongZCorrectedRecoil_LongZ', 'MVA', 0)
plotMVAResponseOverNVertex_woutError('recoilslimmedMETsPuppi_LongZ', 'Puppi', 2)
...
plt.grid()
plt.ylim(0.6, ResponseMax)
plt.savefig("%sResponseMVA_u_para_OverNVertex"%(plotsD))
...
plt.grid()
plt.ylim(0.6, ResponseMax)
plt.savefig("%sResponseMVA_u_para_OverNVertex_wError"%(plotsD))
...
plt.savefig("%sResolutionMVA_u_para_OverPTZ"%(plotsD))
...
plt.grid()
plt.ylim(ylimResMVAMin, ylimResMax)
plt.savefig("%sResolutionMVA_u_para_OverNVertex"%(plotsD))
...
plt.grid()
plt.ylim(ylimResMVAMin, ylimResMax)
plt.savefig("%sResolutionMVA_u_perp_OverPTZ"%(plotsD))
...
plt.grid()
plt.ylim(ylimResMVAMin, ylimResMax)
plt.savefig("%sResolutionMVA_u_perp_OverNVertex"%(plotsD))
...
if __name__ == "__main__":
	...
	print(outputDir)
	NN_Output = h5py.File("%s/NN_Output.h5"%outputDir, "w")
