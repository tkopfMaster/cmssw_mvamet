...
NN_mode="xy"
trainingname="TF_flatnet_9pTbins_5PVbins_booleanmask_tanh_80ES_Taylor_CrossVal_woutReweight_uniformBatchpTtrainval_wSumEt_woutScale_woutVertexReweight_2000Batch_100000GS_20_200_4HL_${PhysicsProcess}_${NN_mode}_${optimizer}_${loss}_003_Part2"
echo "$trainingname"
...
if [ ! -d "$plots_di/$trainingname/" ]; then
  ...
  mkdir $plots_di$trainingname/Thesis/
fi
...
python $src_di/PlotsThesis.py $applyFile $files_di $plots_di $PhysicsProcess $NN_mode
