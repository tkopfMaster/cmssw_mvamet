...
loss="relResponse"
NN_mode="xy"
trainingname="TF_CrossValidation_woutReweight_uniformBatchpTtrainval_wSumEt_woutScale_woutVertexReweight_1000Batch_100000GS_20_200_4HL_${PhysicsProcess}_${NN_mode}_${optimizer}_${loss}"
echo "$trainingname"
