...
def getAngle(METPhi):
    if METPhi=='NN_Phi':
        ...
        deltaPhi = angularrange(DFName[METPhi]+np.pi-DFName['Boson_Phi'])
    return deltaPhi
...
def Hist_Resolution_para(branchString, labelName, errbars_shift, ScaleErr, rangemin, rangemax):
    ...
    plt.hist((-(DFName[branchString][(DFName['Boson_Pt']>rangemin) & (DFName['Boson_Pt']<rangemax)])-DFName['Boson_Pt'][(DFName['Boson_Pt']>rangemin) & (DFName['Boson_Pt']<rangemax)]), bins=nbinsHist, range=[ResolutionParaMin, ResolutionParaMax], label=labelName+', %8.2f $\pm$ %8.2f'%(Mean, Std), histtype='step', ec=colors_InOut[errbars_shift])
...
def Hist_Resolution_perp(branchString, labelName, errbars_shift, ScaleErr, rangemin, rangemax):
    ...
    plt.hist(DFName[branchString][(DFName['Boson_Pt']>rangemin) & (DFName['Boson_Pt']<rangemax)], bins=nbinsHist, range=[ResolutionPerpMin, ResolutionPerpMax], label=labelName+', %8.2f $\pm$ %8.2f'%(Mean, Std), histtype='step', ec=colors_InOut[errbars_shift])
...
def getPlotsOutput(inputD, filesD, plotsD,DFName, DFName_nVertex):
    ...
    METpT_NN = DFName.Boson_Pt.values[getResponseIdx('NN_LongZ')]
    METpT_GBRT = DFName.Boson_Pt.values[getResponseIdx('LongZCorrectedRecoil_LongZ')]
    METpT_PF = DFName.Boson_Pt.values[getResponseIdx('recoilslimmedMETs_LongZ')]
    ...
    Hist_Response('LongZCorrectedRecoil_LongZ', 'GBRT', 5, ScaleErr, 0, 10)
    Hist_Response('NN_LongZ', 'NN', 6, ScaleErr, 0, 10)
    Hist_Response('recoilslimmedMETs_LongZ', 'PF', 1, ScaleErr, 0, 10)
    #Hist_Response('ScaledNN_LongZ', 'NN', 0, ScaleErr)
    plt.plot([1, 1], [0, 90000], color='k', linestyle='--', linewidth=1)
    ...
    Hist_Response('LongZCorrectedRecoil_LongZ', 'GBRT', 5, ScaleErr, 10, 125)
    Hist_Response('NN_LongZ', 'NN', 6, ScaleErr, 10, 125)
    Hist_Response('recoilslimmedMETs_LongZ', 'PF', 1, ScaleErr, 10, 125)
    #Hist_Response('ScaledNN_LongZ', 'NN', 0, ScaleErr)
    plt.plot([1, 1], [0, 90000], color='k', linestyle='--', linewidth=1)
    ...
    Hist_Response('LongZCorrectedRecoil_LongZ', 'GBRT', 5, ScaleErr, 125, 200)
    Hist_Response('NN_LongZ', 'NN', 6, ScaleErr, 125, 200)
    Hist_Response('recoilslimmedMETs_LongZ', 'PF', 1, ScaleErr, 125, 200)
    #Hist_Response('ScaledNN_LongZ', 'NN', 0, ScaleErr)
    ...
    Hist_Resolution_para('LongZCorrectedRecoil_LongZ', 'GBRT', 5, ScaleErr, 0, 10)
    Hist_Resolution_para('NN_LongZ', 'NN', 6, ScaleErr, 0, 10)
    #Hist_Resolution_para('ScaledNN_LongZ', 'NN scaled', 0, ScaleErr)
    Hist_Resolution_para('recoilslimmedMETs_LongZ', 'PF', 1, ScaleErr, 0, 10)
    ...
    Hist_Resolution_para('LongZCorrectedRecoil_LongZ', 'GBRT', 5, ScaleErr, 10, 125)
    Hist_Resolution_para('NN_LongZ', 'NN', 6, ScaleErr, 10, 125)
    #Hist_Resolution_para('ScaledNN_LongZ', 'NN scaled', 0, ScaleErr)
    Hist_Resolution_para('recoilslimmedMETs_LongZ', 'PF', 1, ScaleErr, 10, 125)
    ...
    Hist_Resolution_para('LongZCorrectedRecoil_LongZ', 'GBRT', 5, ScaleErr, 125, 200)
    Hist_Resolution_para('NN_LongZ', 'NN', 6, ScaleErr, 125, 200)
    #Hist_Resolution_para('ScaledNN_LongZ', 'NN scaled', 0, ScaleErr)
    Hist_Resolution_para('recoilslimmedMETs_LongZ', 'PF', 1, ScaleErr, 125, 200)
    ...
    Hist_Resolution_perp('LongZCorrectedRecoil_PerpZ', 'GBRT', 5, ScaleErr, 0, 10)
    Hist_Resolution_perp('NN_PerpZ', 'NN', 6, ScaleErr, 0, 10)
    Hist_Resolution_perp('recoilslimmedMETs_PerpZ', 'PF', 1, ScaleErr, 0, 10)
    ...
    Hist_Resolution_perp('LongZCorrectedRecoil_PerpZ', 'GBRT', 5, ScaleErr, 10, 125)
    Hist_Resolution_perp('NN_PerpZ', 'NN', 6, ScaleErr, 10, 125)
    Hist_Resolution_perp('recoilslimmedMETs_PerpZ', 'PF', 1, ScaleErr, 10, 125)
    ...
    Hist_Resolution_perp('LongZCorrectedRecoil_PerpZ', 'GBRT', 5, ScaleErr, 125, 200)
    Hist_Resolution_perp('NN_PerpZ', 'NN', 6, ScaleErr, 125, 200)
    Hist_Resolution_perp('recoilslimmedMETs_PerpZ', 'PF', 1, ScaleErr, 125, 200)
    ...
    dPhi = np.linspace(-np.pi, np.pi, 200)
    Response_pTperfect = np.cos(dPhi)
    mean_Response_wErr('NN_LongZ', 'NN_Phi', 'NN', 6, 1, 0, 10, 20)
    #mean_Response_wErr('ScaledNN_LongZ', 'NN_PerpZ', 'NN scaled', 0, ScaleErr)
    mean_Response_wErr('recoilslimmedMETs_LongZ', 'recoilslimmedMETs_Phi', 'PF', 1, 1, 0, 10, 20)
    plt.plot(np.linspace(-np.pi, np.pi, 2000), np.cos(np.linspace(-np.pi, np.pi, 2000)), linewidth=2, markersize=12, label='$\cos \Delta \\alpha$')
    plt.legend()
    #plt.ylim(-8,5)
    plt.grid()
    ...
    dPhi = np.linspace(-np.pi, np.pi, 200)
    Response_pTperfect = np.cos(dPhi)
    mean_Response_wErr('NN_LongZ', 'NN_Phi', 'NN', 6, 1, 125, 200, 10)
    #mean_Response_wErr('ScaledNN_LongZ', 'NN_PerpZ', 'NN scaled', 0, ScaleErr)
    mean_Response_wErr('recoilslimmedMETs_LongZ', 'recoilslimmedMETs_Phi', 'PF', 1, 1, 125, 200, 10)
    plt.plot(np.linspace(-np.pi, np.pi, 2000), np.cos(np.linspace(-np.pi, np.pi, 2000)), linewidth=2, markersize=12, label='$\cos \Delta \\alpha$')
    plt.legend()
    #plt.ylim(-8,5)
    plt.grid()
    ...
    plt.xlabel("$ \Delta \\alpha $")
    plt.ylabel("$|U|-|\mathrm{MET}|$")
    heatmap, xedges, yedges = np.histogram2d(  angularrange(DFName['NN_Phi']+np.pi-DFName['NN_Phi']), DFName['NN_Pt'] - DFName['Boson_Pt'],  bins=50,
                                             range=[[-np.pi,np.pi],
                                                    [-10,10]])
    extent = [xedges[0], xedges[-1], yedges[0], yedges[-1]]
    #plt.clf()
    ...
    Response = np.divide(-DFName['recoilpatpfPUMET_LongZ'], DFName['Boson_Pt'] )
    Response = Response[~np.isnan(Response)]
    heatmap, xedges, yedges = np.histogram2d(  angularrange(DFName['recoilpatpfPUMET_Phi']+np.pi-DFName['Boson_Phi']), Response,  bins=50,
                                             range=[[-np.pi,np.pi],
                                                    [0,2]])
    extent = [xedges[0], xedges[-1], yedges[0], yedges[-1]]
    #plt.clf()
    ...
    plt.ylabel("Response")
    heatmap, xedges, yedges = np.histogram2d(  DFName['Boson_Pt'][getResponseIdx('NN_LongZ')], getResponse('NN_LongZ'),  bins=[25,25],
                                             range=[[0,10],
                                                    [0,2]])
    extent = [xedges[0], xedges[-1], yedges[0], yedges[-1]]
    #plt.clf()
    ...
    plt.xlabel("$ \Delta \\alpha $")
    plt.ylabel("Response")
    heatmap, xedges, yedges = np.histogram2d(  DFName['Boson_Pt'], getResponse('NN_LongZ'),  bins=[25,25],
                                             range=[[0,10],
                                                    [0,2]])
    extent = [xedges[0], xedges[-1], yedges[0], yedges[-1]]
    #plt.clf()
    ...
    plt.xlabel("$ |\\vec{\mathrm{MET}}| $")
    plt.ylabel("Response")
    heatmap, xedges, yedges = np.histogram2d(  DFName['Boson_Pt'][getResponseIdx('recoilpatpfPUMET_LongZ')], getResponse('recoilpatpfPUMET_LongZ'),  bins=[25,25],
                                             range=[[0,10],
                                                    [0,2]])
    extent = [xedges[0], xedges[-1], yedges[0], yedges[-1]]
    #plt.clf()
